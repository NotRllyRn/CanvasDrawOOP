...
function CanvasDraw.CreateCanvas(Frame: GuiObject, Resolution: Vector2, CanvasColour: Color3, BlurEnabled: boolean): {}
	...
	CurrentCanvasResolutionX = CanvasDraw.Resolution.X
	CurrentCanvasResolutionY = CanvasDraw.Resolution.Y

	-- Create the canvas
	CurrentCanvas = GradientCanvas.new(CurrentCanvasResolutionX, CurrentCanvasResolutionY, BlurEnabled)
	CurrentCanvas:SetParent(Frame)
